...
<form action="cadastrar_aluno.php" method="post" onsubmit="return funcVerifyLogin()">
	<table>
		<tr>
		<th>
		...
		<td>
		<input type="number" id="matricula" name="matricula" required="required"/>
		</td>
		<th>
		...
		<td>
		<input type="date" id="data_val" name="data_val" required="required"/>
		</td>
		</tr>
